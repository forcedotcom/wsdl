...
export type RecsOutputFieldName =
  | 'Summary'
  | 'Issue'
  | 'Resolution'
...
export type PredictionPlatform = 'Einstein_Discovery' | 'Default' | 'Data_Cloud' | 'Einstein_on_Data_Cloud';
...
export type ItemActionType = 'Omniscript' | 'Aura' | 'LWC';
...
export type ActionPlanTemplateType = 'Industries' | 'Retail' | 'Sales' | 'ITSM' | 'PrvdEngmtCompliance' | 'KAM';

export type ActivationFlowType = 'SEGMENT' | 'DMO' | 'API_TRIGGERED';

export type ActivationPlatformConnectorType = 'S3' | 'OAUTH';

export type ActivationPlatformCreationType = 'JSON' | 'MANUAL';

export type ActivationPlatformFileOutputFormat = 'CSV' | 'JSON' | 'PARQUET';

export type ActivationPlatformFileOutputGrouping = 'PER_SEGMENT' | 'PER_ACCOUNT' | 'PER_USER';

export type ActivationPlatformPeriodicFullRefresh = 'REFRESH_30' | 'REFRESH_60';

export type ActivationPlatformProcessingType = 'Batch' | 'Streaming';
...
export type AffinityScoreType = 'RFM' | 'CAP';
...
export type AnalyticsWidgetType = 'visualization' | 'text' | 'filter' | 'parameter' | 'button' | 'metric' | 'container';

export type AnalyticsActionType = 'recordaction' | 'flow' | 'navigate';

export type AnalyticsActionEventType = 'click' | 'select';

export type AnalyticsWorkspaceAssetType =
  | 'AnalyticsDashboard'
...
export type AnalyticsWorkspaceAssetUsageType = 'Created' | 'Referenced';

export type VisualizationFieldDisplayCategoryType = 'Discrete' | 'Continuous';

export type VisualizationFieldFunctionType =
  | 'Sum'
  | 'Avg'
  | 'Median'
  | 'Count'
...
export type VisualizationFieldRoleType = 'Dimension' | 'Measure';

export type VisualizationFieldType = 'Field' | 'MeasureNames' | 'MeasureValues' | 'AdHocCalculation';
...
export type BatchCalcJobCSVDelimiter = 'COMMA' | 'BACKQUOTE' | 'CARET' | 'PIPE' | 'SEMICOLON' | 'TAB';

export type BatchCalcJobDataType = 'Text' | 'Numeric' | 'Date' | 'DateTime' | 'MultiValue' | 'Boolean';
...
export type BatchCalcJobParameterDataType =
  | 'Text'
  | 'Numeric'
  | 'Date'
  | 'DateTime'
...
export type BatchCalcJobWritebackKeyType = 'PrimaryKey' | 'QualifierKey';

export type BatchCalcJobWritebackOpn = 'Insert' | 'Update' | 'Upsert' | 'Delete' | 'Overwrite';

export type BatchCalcJobWritebackType =
  | 'sObject'
  | 'Analytics'
  | 'DataLakeObject'
  | 'DataModelObject'
...
export type BatchCalcJobDefRunMode = 'Batch' | 'OnDemand';

export type ExecutionPlatformObjectType = 'None' | 'DataModelObject' | 'DataLakeObject' | 'CalculatedInsightsObject';
...
export type DataSourceType = 'SingleSobject' | 'MultipleSobjects';
...
export type BotSourceType = 'None' | 'B2ASandboxBot' | 'B2AProdBot';
...
export type ConversationVariableVisibilityType = 'Internal' | 'External';
...
export type BriefcaseType = 'Standard' | 'HighVolume' | 'MobileAppSync';
...
export type APIInstanceAccessStatus =
  | 'Approved'
  | 'Pending'
  | 'NoStatus'
  | 'NotAccessible'
...
export type APIInstanceApprovalType = 'ManualApproval' | 'AutoApproval' | 'NoApproval';

export type ExternalServiceRegistrationProviderType =
  | 'MuleSoft'
  | 'Custom'
  | 'SchemaInferred'
  | 'Standard'
...
export type CCRDType = 'Loss' | 'Expense';
...
export type CodeFeature = 'ServiceCloudVoice' | 'ServiceCloudNative';

export type CodeProvider = 'Bandwidth' | 'Inteliquent' | 'Sinch';

export type CodeProvisioningStatus =
  | 'UNKNOWN'
  | 'WAITING'
  | 'IN_PROGRESS'
  | 'DONE'
...
export type CommunicationChannelLineType = 'ShortCode' | 'LongCode' | 'AlphaNumeric';
...
export type SourceCountryCode = 'US' | 'CA' | 'MX';
...
export type ContextMappingIntentType = 'hydration' | 'association' | 'persistence' | 'translation';
...
export type ContextMappingConfigUsageType = 'Claim' | 'CaseIntakeForm' | 'DiseaseDefinition';

export type ContextMappingType = 'Hydration' | 'Persistence';

export type ContextUseCaseType = 'ContractCreationOrUpdation' | 'ContractExtraction';
...
export type ConvIntelligenceActionType = 'LaunchNBA' | 'LaunchFlow' | 'AlertSupervisor' | 'AlertSupervisorAndAgent';

export type ConvParticipantRole = 'Agent' | 'Customer' | 'AgentOrCustomer';

export type ConvIntelligenceService =
...
export type ConvIntelligenceOperator = 'Equals' | 'NotEquals' | 'LessThan' | 'GreaterThan' | 'In';

export type ConvIntelligenceType = 'Category' | 'Keyword' | 'AgentSentiment' | 'CustomerSentiment' | 'Intent';
...
export type CustomChannelConnectedAppType = 'Partner' | 'Customer';

export type ConsentOwner = 'Salesforce' | 'Partner';

export type RoutingOwner = 'Salesforce' | 'Partner';

export type ConversationMessageConstantType = 'Title' | 'Url' | 'Image' | 'Options' | 'SubTitle' | 'Custom';
...
export type ConversationMessageContentCategory =
  | 'Response'
  | 'Reminder'
  | 'Feedback'
  | 'OrderUpdate'
...
export type ConversationMessageHandlerType =
  | 'QuickAction'
  | 'AuthProvider'
  | 'PaymentProvider'
  | 'Attachment'
...
export type ConvMsgExternalErrorCode =
  | 'InvalidParameter'
  | 'IntegrityError'
  | 'InternalError'
  | 'PublishError'
...
export type ConvMsgExternalRejectionReason =
  | 'AbusiveContent'
  | 'IncorrectCategory'
  | 'InvalidFormat'
  | 'Scam'
...
export type ConvMsgExternalTemplateVersionType = 'Legacy' | 'Template' | 'Flow';
...
export type ElementType = 'Float' | 'Text';
...
export type MappingAlertType = 'None' | 'Warning' | 'Error';

export type MktDataModelFieldUsageTag = 'None' | 'KeyQualifier';

export type SummaryOperations = 'count' | 'sum' | 'min' | 'max';

export type NotificationActionType = 'NotificationApiAction' | 'Share';
...
export type CalculatedInsightCreationType = 'Custom' | 'System';
...
export type DataConnectorDataType =
  | 'CHECKBOX'
  | 'COMBOBOX'
  | 'RADIO'
  | 'RADIO_BUTTONS'
...
export type DataConnectorFeature =
  | 'Hidden'
  | 'DataIn'
  | 'DataInStructured'
  | 'DataInUnstructured'
...
export type DataConnectorReleaseLevel = 'IN_DEV' | 'PILOT' | 'BETA' | 'GA';

export type DataModelType = 'Source' | 'Transport' | 'Landing' | 'View' | 'Reference';

export type AccelerationEnabled = 'YES' | 'NO';

export type DataObjectType = 'Object' | 'Table' | 'Api';

export type StorageType = 'LOCAL' | 'EXTERNAL';

export type DataImportDataExtractMethods = 'FULL_REFRESH' | 'NUMERIC_CDC' | 'BINARY_CDC' | 'DATETIME_CDC';
...
export type StreamType = 'INGEST' | 'DIRECT_ACCESS' | 'DIRECT_ACCESS_ACCELERATED';

export type StreamingAppDataConnectorType = 'MobileApp' | 'WebApp' | 'ServerApp';
...
export type DecisionTableDataSourceType = 'SingleSobject' | 'MultipleSobjects' | 'CsvUpload' | 'ContextDefinition';

export type DTParameterDataType = 'String' | 'Number' | 'Date' | 'Boolean' | 'Percent' | 'Currency' | 'DateTime';
...
export type DecisionTableParameterType = 'INPUT' | 'ROWCRITERIA' | 'OUTPUT';
...
export type DecisionTableDownloadStatus = 'DownloadInProgress' | 'Completed' | 'Failed';

export type DecisionTableExecutionType = 'Soql' | 'Hbpo' | 'Dmo' | 'Solr' | 'Hbase';
...
export type DecisionTableUploadStatus = 'UploadInProgress' | 'Completed' | 'CompletedWithErrors' | 'Failed';

export type FTestTopLevelSelection = 'SelOne' | 'SelTwo' | 'SelThree';

export type SchedulingCategory = 'B' | 'A';

export type SchedulingObjectiveType =
  | 'AgentPreference'
  | 'BalanceShifts'
...
export type ObjectiveParameterKey =
  | 'DaysBack'
  | 'DaysAhead'
  | 'PrioritizeResource'
  | 'MinimumGapDuration'
...
export type LearningAchievementType =
  | 'LearningCourse'
  | 'LearningProgram'
  | 'AchievementGroup'
  | 'AchievementGroupAll'
...
export type ServicePlanSourceType = 'Case' | 'VoiceCall' | 'MessagingSession';
...
export type CustomFieldDisplayType = 'Dropdown' | 'ColorSwatch' | 'Pill';

export type SupportedChannel = 'Email' | 'Sms' | 'WhatsApp';

export type MappingBehaviorType = 'PointInTime' | 'CurrentValue';

export type RRADJctObjFilterLogic = 'And' | 'Or' | 'Custom';

export type RelatedRecordAccessDefShareTo = 'Internal' | 'External' | 'All';

export type RRADSourceObjFilterLogic = 'And' | 'Or' | 'Custom';

export type RelatedRecordAccessDefStatus = 'Draft' | 'Active' | 'Inactive';

export type RRADTargetObjFilterLogic = 'And' | 'Or' | 'Custom';

export type RRAFObjectType = 'Source' | 'Target' | 'Junction';

export type RRAFOperator =
  | 'Equal'
  | 'Not_Equal'
  | 'Starts_With'
  | 'Contains'
...
export type ObjectAccessLevel = 'Edit' | 'Read' | 'None';
...
export type ActionableListType = 'RetailStoreList' | 'HealthcareProviderList';
...
export type SchedulingParameterKey =
  | 'L'
  | 'R'
  | 'W'
  | 'T'
...
export type DgtAssetMgmtPrvdLghtCpntType = 'NONE' | 'DIGITAL_ASSET_MANAGER';

export type ManagedContentSpaceModuleStatusEnum =
  | 'ENABLED'
  | 'DISABLED'
  | 'ERROR'
  | 'INVALID'
...
export type TokenMappingMethodType = 'OmniDataTransform' | 'CustomClass' | 'ContextService';
...
export type DocumentTemplateUsageType =
...
export type EmbeddedServiceDeploymentType = 'Web' | 'Mobile' | 'API' | 'InternalCopilot';
...
export type EmbeddedServiceFormDisplayContext = 'None' | 'Conversation' | 'Session';

export type EmbeddedServiceFormFieldType = 'Text' | 'Email' | 'Phone' | 'Number' | 'Checkbox' | 'ChoiceList';

export type MessagingChannelParameterType = 'Standard' | 'Custom';

export type EmbeddedServiceLayoutType = 'FS_AppointmentHome';

export type EswInvitationConditionResource =
  | 'SecondsOnPage'
  | 'SecondsOnSite'
  | 'NumberOfPageViews'
  | 'UrlMatch'
...
export type EswInvitationConditionOperator =
  | 'Equals'
  | 'NotEqual'
  | 'LessThan'
  | 'GreaterThan'
...
export type EmployeeUseCaseMethod = 'Get' | 'Post' | 'Put' | 'Patch' | 'Delete';

export type EmployeeUseCaseStatus = 'Draft' | 'Inactive' | 'Active';

export type EnablementAggregationType = 'Sum' | 'Count' | 'Average';

export type EnablementFilterOperator =
  | 'Equals'
  | 'DoesNotContain'
  | 'DoesNotEqual'
  | 'IsNull'
...
export type EnblProgramMeasureStatus = 'Draft' | 'Published' | 'Archived';

export type ProgramExtContentDefProvider = 'Trailhead';

export type EnblCompositeMilestoneType = 'Addition' | 'Division' | 'Percentage';

export type ProgramTaskDefCategory = 'Exercise' | 'Milestone';

export type MilestoneTimeUnits = 'Minutes' | 'Hours' | 'Days';

export type EventDeliveryType = 'StartFlow' | 'ResumeFlow';

export type EventRelayAdminState = 'RUN' | 'STOP' | 'PAUSE' | 'DELETE';

export type EventRelayUsageType = 'AMAZON_EVENTBRIDGE' | 'INTERNAL_MANAGED_SUBSCRIPTIONS' | 'INTERNAL_REPLICATION';

export type ExperienceContainerType = 'SFS' | 'SAPP' | 'TEST' | 'LEX' | 'SCMA' | 'SAPPMOBILEHOME';

export type ActionLogSchemaType = 'Other' | 'ExpressionSet';

export type EASAppType =
  | 'PublicSector'
  | 'Loyalty'
  | 'HealthCloud'
...
export type ExpsSetExecutionScale = 'Low' | 'High';

export type ExpsSetInterfaceSourceType =
  | 'PricingProcedure'
...
export type ResourceInitializationType = 'Default' | 'Off';

export type ExpsSetUsageSubtype =
  | 'SampleSubtype1'
  | 'SampleSubtype2'
  | 'SampleSubtype3'
  | 'AcadTermRgstrTmln'
...
export type ExpsSetVariableType =
  | 'Variable'
  | 'Constant'
  | 'Formula'
...
export type BotProvider = 'Custom' | 'GoogleCCAI';

export type ChannelMode = 'Messaging' | 'Voice';

export type ExternalBotType = 'Chatbot';

export type ExtConvParticipantIntegDefStatus = 'Active' | 'Inactive' | 'Deleted';
...
export type IdentityProviderAuthFlow = 'AuthorizationCode' | 'ClientCredentials' | 'JwtBearer' | 'SalesforceDefined';

export type IdentityProviderAuthProtocol = 'OAuth' | 'SalesforceDefined';

export type ExtlIdentityProviderParmType =
  | 'AuthorizeUrl'
  | 'TokenUrl'
  | 'UrlQueryParameter'
  | 'HttpHeader'
...
export type ExtlClntAppDistState = 'Local' | 'Packaged' | 'Managed' | 'AutoInstalled';
...
export type DataConnectionStatus = 'Connected' | 'Failed' | 'Disconnected' | 'NeedsReAuthentication';
...
export type StorageDriveType = 'MicrosoftOneDrive' | 'GoogleDrive';

export type TargetObject = 'All' | 'Contract' | 'DocumentTemplate' | 'Disclosure' | 'InfoLibraryExternalDocument';

export type ExtlClntAppStartPage = 'None' | 'Custom' | 'OAuth' | 'SAML';
...
export type JWTSessionTimeoutType = 'UserSession' | 'Custom';
...
export type ApplePushEnvironmentType = 'Sandbox' | 'Production';

export type PushServiceType = 'Apple' | 'Android';

export type ExtlClntAppSamlEncryptType = 'AES_128' | 'AES_256';

export type ExtlClntAppNameIdFormatType = 'Unspecified' | 'EmailAddress' | 'Persistent' | 'Transient';

export type ExtlClntAppSamlSignAlgoType = 'SHA1' | 'SHA256';

export type ExtlClntAppSamlBindingType = 'RedirectBinding' | 'PostBinding';

export type ExtlClntAppSamlSubjectType =
  | 'Username'
  | 'FederationId'
  | 'UserId'
  | 'SpokeId'
...
export type FieldMappingConfigProcessType = 'GiftEntry' | 'Incident' | 'Problem' | 'ChangeRequest';
...
export type AscAutomaticMode = 'Off' | 'Manual' | 'Semi' | 'Full';

export type BgGeoLocationAccuracy = 'Medium' | 'Coarse' | 'VeryCoarse';

export type DestinationTypeForMetadata = 'LatitudeAndLongitude' | 'Address';

export type GeoLocationAccuracy = 'Fine' | 'Medium' | 'Coarse';

export type TimeIntervalSetupForMetadata = 'one' | 'five' | 'fifteen' | 'twenty' | 'thirty' | 'sixty';
...
export type FieldSrcTrgtRelationshipOwner = 'SObject' | 'DataCloud';
...
export type FlexipageDataSourceTypeEnum = 'Record' | 'User' | 'Organization' | 'Apex';
...
export type FlowComplexValueType =
  | 'JoinDefinition'
  | 'FieldReference'
  | 'ResourceDescriptor'
...
export type FlowInputConfiguratorMode = 'Custom' | 'Resource' | 'Transform';
...
export type FlowTransformValueActionType = 'Map' | 'Count' | 'Sum' | 'GetItemByIndex' | 'InnerJoin' | 'InvocableAction';
...
export type FlowAttributeType = 'LlmPrompt' | 'LlmDescription';
...
export type FlowStageStepAssigneeType = 'User' | 'Group' | 'Queue' | 'Invalid' | 'Resource';

export type FlowScheduledPathOffsetUnit = 'Hours' | 'Days' | 'Minutes' | 'Months' | 'Weeks';

export type FlowScheduledPathType = 'AsyncAfterCommit' | 'ApprovalRecall';
...
export type FlowWaitInteractionType = 'SmsResponse' | 'WhatsappResponse';
...
export type FlowExperimentFallbackMode = 'BestPerformer' | 'Randomize';

export type FlowExperimentType = 'Random' | 'Manual' | 'Automatic';

export type IterationOrder = 'Asc' | 'Desc';

export type FlowNodeGroupType = 'generic' | 'rpa';

export type FlowEntryType = 'Always' | 'AfterCompletion' | 'Never';
...
export type FlowEnvironment = 'Default' | 'Slack' | 'Offline';

export type FlowRunInMode = 'DefaultMode' | 'SystemModeWithSharing' | 'SystemModeWithoutSharing';

export type FlowVersionStatus = 'Active' | 'Draft' | 'Obsolete' | 'InvalidDraft' | 'UnderReview';

export type FlowTestActivationStatus = 'Active' | 'Inactive';

export type FlowTestParameterType =
...
export type AttributeMappingType = 'ActionAttribute' | 'Constant' | 'Variable' | 'ContextVariable';

export type PluginType = 'Topic' | 'APICustomTopic';
...
export type GenAiAgentVariableType = 'Variable' | 'ContextVariable' | 'Attribute';

export type GenAiRuleExpressionOperator =
  | 'equal'
  | 'greaterThan'
  | 'greaterThanOrEqual'
  | 'lessThan'
...
export type ExpressionType = 'sel' | 'handlebars';

export type GenAiPromptTemplateResponseFormat = 'MarkDown' | 'JSON' | 'HTML';

export type GenAiPromptTemplateStatus = 'Published' | 'Draft';

export type GenAiPromptTemplateVisibilityType = 'Locked' | 'Internal' | 'API' | 'Global';

export type GenAiPromptTemplateActvAccessLevel = 'Allowed' | 'Blocked';
...
export type IFrameWhitelistContext = 'VisualforcePages' | 'LightningOut' | 'Surveys' | 'DCH_ADDIN_APP';

export type ExternalConnectionType = 'AwsPrivateLink' | 'DataCloudPrivateConnection';
...
export type InsPolicyLifecycleProcess =
  | 'Renew_Same_Carrier'
...
export type InsRatePlanCmsnConfigCalcType = 'Flat' | 'Graded';
...
export type InvocableActionExtAttributeDataType = 'String' | 'Boolean' | 'Integer' | 'Date' | 'Double' | 'Long';

export type InvocableActionExtTargetType = 'ActionDefinition' | 'ActionParameter' | 'TypeDefinition' | 'TypeProperty';
...
export type LifeSciConfigCategoryType =
  | 'DbSchema'
  | 'UISchema'
  | 'CalendarEvent'
...
export type LifeSciCategoryType = 'Hierarchical' | 'List';

export type LifeSciAssignmentLevel = 'Profile' | 'User';

export type LifeSciConfigFieldDataType =
  | 'TEXT'
  | 'LONGTEXT'
  | 'NUMBER'
  | 'BOOLEAN'
...
export type LightningDesignSystemVersion = 'SLDS_v1' | 'SLDS_v2';
...
export type ApiSource = 'CONNECT' | 'CLASSIC';

export type AutoResponseContentType = 'TextResponse' | 'MessageDefinition';

export type MessagingAutoResponseType =
  | 'InitialResponse'
...
export type MessagingChannelConsentType = 'ImplicitOptIn' | 'ExplicitOptIn' | 'DoubleOptIn';

export type MessagingChannelUsageDeploymentType =
...
export type EmbeddedServiceAuthModeType = 'Auth' | 'UnAuth';

export type MessagingAuthorizationType = 'PublicKeyCertificateSet' | 'AuthProvider';

export type EmbeddedMsgQueueLimitType = 'QueueLength' | 'QueueLengthPerAgent';
...
export type MessagingKeywordType = 'OptIn' | 'DoubleOptIn' | 'OptOut' | 'Help' | 'Custom';

export type MessagingSessionHandlerType = 'Queue' | 'Flow' | 'User' | 'AgentforceServiceAgent';
...
export type MktDataConnectionStatus =
  | 'PROCESSING'
  | 'INACTIVE'
  | 'TESTING'
  | 'ACTIVE'
...
export type MlModelConnectorType =
  | 'SAGEMAKER_DEPLOYED'
  | 'OPEN_AI'
  | 'AZURE_OPEN_AI'
  | 'GENERIC'
...
export type MlModelType = 'Predictive' | 'Generative' | 'Unknown';
...
export type MlModelSourceType = 'ModelConnector' | 'EdcNoCode' | 'OutOfTheBox' | 'FineTuned';

export type MlAIModelType = 'ModelArtifact' | 'ConfiguredModel';

export type MlModelEndpointType = 'REAL_TIME_INFERENCE' | 'BATCH_INFERENCE';

export type MlInferenceFormat =
  | 'JSON_DENSE'
  | 'CSV'
  | 'JSON_INSTANCES'
  | 'DATAFRAME_RECORDS'
...
export type EdgeRoutingOption = 'global' | 'regional';
...
export type ChangeEventType = 'Create' | 'Update' | 'Delete' | 'Undelete';
...
export type OmniSupervisorTabType =
  | 'Wallboard'
  | 'Agents'
  | 'QueuesBacklog'
  | 'AssignedWork'
...
export type GatewayType = 'Stripe' | 'Paypal' | 'Adyen' | 'Braintree' | 'Cybersource';
...
export type PlatformEventChannelEventType = 'custom' | 'standard' | 'monitoring' | 'data';
...
export type EnforcementRuleEffect = 'Forbid' | 'Permit' | 'Transform';

export type RulePrincipalScopeType = 'ANY';

export type PrincipalAuthenticationLevel = 'UNIDENTIFIED' | 'IDENTIFIED' | 'AUTHENTICATED' | 'INTERNAL';

export type RuleResourceScopeType = 'ANY' | 'FIELD' | 'RECORD';
...
export type RuleConsumer = 'ALL' | 'DATACLOUD' | 'MULESOFT' | 'TABLEAU' | 'CORE';

export type RuleDefinitionClause = 'UNLESS' | 'WHEN';

export type RuleContextPath = 'SESSION_DATASPACE' | 'SESSION_CONTACT_ID';
...
export type PublicKeyCertificateSetType = 'JWKS' | 'JWKS_URL';
...
export type RecordActionType = 'Flow' | 'QuickAction' | 'Omniscript' | 'LWC' | 'WebLink' | 'SvcCatalogItemDef';
...
export type ContextRuleUsageType =
  | 'UnifiedPromotions'
  | 'Default'
  | 'Configurator'
  | 'Dfo'
...
export type ActualsCalculationMode = 'Manual' | 'Orders' | 'OrdersThroughContracts' | 'DataProcessingEngine';
...
export type SearchCriteriaConfigurationConfigurationType = 'DefaultSearch' | 'ClinicalTrialSearch';
...
export type SearchResultActionScope = 'Global' | 'Inline';
...
export type UntrustedRedirectEnum = 'AlwaysAllowed' | 'AllowWithUserPermission' | 'NeverAllowed';
...
export type CapacityModel = 'TAB_BASED' | 'STATUS_BASED';

export type StatusFieldMappingType = 'IN_PROGRESS' | 'PAUSED' | 'COMPLETED';
...
export type SvcCtlgItemDpndProcType = 'RequestForm' | 'FulfillmentFlow' | 'IntegrationDefinition' | 'Preprocessor';
...
export type DistanceMeasurementUnit = 'Miles' | 'Kilometers';

export type SchedulingMode = 'Sliding' | 'Reshuffle' | 'Normal';
...
export type SrvcMgmtCollabAppRefObjType = 'Incident' | 'Problem' | 'ChangeRequest' | 'Release' | 'Case' | 'Knowledge';
...
export type StageCriteriaType = 'AND' | 'OR' | 'CUSTOMLOGIC';

export type StageCriteriaExecType = 'CONDITION' | 'FLOW';

export type StageUserPermission =
  | 'ProcessOrder'
...
export type TelemetryActnDefStepOpType = 'Retrieve' | 'Submit';

export type TelActnDefStepAttrDataType =
  | 'Float'
  | 'Integer'
  | 'Double'
  | 'Boolean'
...
export type TelemetryActnDefStepAttrType = 'Actuator' | 'Sensor';

export type TelemetryDefinitionUsageType = 'ConnectedVehicle' | 'ConnectedAsset';
...
export type RuleEngine = 'StandardConfigurator' | 'AdvancedConfigurator';

export type SaveType = 'Standard' | 'Large';

export type TPTPricingPreference = 'Force' | 'System' | 'Skip';
...
export type UploadStatus = 'complete' | 'uploading';

export type AssignmentType = 'defaultMedia' | 'customMedia';
...
export type TaxLocaleType = 'Net' | 'Gross' | 'Automatic';

export type OrderLifeCycleType = 'MANAGED' | 'UNMANAGED';

export type PricingStrategy = 'LowestPrice' | 'Priority';

export type ProductGrouping = 'BestMatch' | 'VariationParent' | 'NoGrouping';
...
export type EmbeddedServiceClientVersion = 'WebV1' | 'WebV2';

export type SurfaceType = 'Messaging' | 'NextGenChat' | 'ServiceEmail' | 'Telephony' | 'CustomerWebClient';
