...
export type SemanticGeoRoleType =
  | 'AIRPORT'
  | 'AREA_CODE'
  | 'CBSA_MSA'
  | 'CITY'
...
export type SemanticAggregationType =
  | 'SUM'
  | 'AVERAGE'
  | 'MIN'
  | 'MAX'
...
export type RuleFilterCriteriaType =
  | 'Aggregate'
  | 'Branch'
  | 'List'
  | 'Eligibility'
...
export type RuleRefVariableDataType =
  | 'Text'
  | 'Numeric'
  | 'Date'
  | 'DateTime'
